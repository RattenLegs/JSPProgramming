...
<!-- 
 ...
 -->	
	...
	액션 태그는 액션과 커스텀으로 나뉘어져있으며 JSP 페이지에서 특별한 기능을 제공한다.<br>
	커스텀 태그는 JSP를 확장시켜주는 기능으로서, 개발자가 직접 개발해야 한다. <br>
	그 중 표준화된 라이브러리를 JSTL(JavaServer Pages Standard Tag Library)이라 한다.<br>
	JSTL은 if-else 조건문 그리고 for 구문과 같은 반복 처리를 커스텀 태그를 이용해서 구현할 수 있도록 해 준다.<br>
	자바 언어에 익숙하지 않더라도 JSTL을 이용하여 어느 정도 논리적인 처리를 수행할 수 있다.<br>
	<br>
	<br>
