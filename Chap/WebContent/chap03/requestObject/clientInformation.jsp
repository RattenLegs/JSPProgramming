...
<body>
	...
	<br>
	<table border='1'>
	<caption>request 기본 객체의 클라이언트 및 서버 정보 관련 메서드</caption>
		<tr>
			<th>메서드</th>
			<th>리턴 타입</th>
			<th>설명</th>
		...
		<tr>
			<td>getRemoteAdd()</td>
			<td>String</td>
			<td>웹 서버에 연결된 클라이언트의 IP 주소를 구한다. <br> 게시판이나 방명록 등에서 글 작성자의
				IP 주소가 자동으로 입력되기도 하는데, <br> 이 때 입력되는 IP 주소가 바로 이 메서드를 사용하여 구현한
				것이다.
			</td>
		</tr>
		<tr>
			...
			<td>long</td>
			<td>클라이언트가 전송한 요청 정보의 길이를 구한다. 
			<br> 전송된 데이터의 길이를 알 수 없는 경우 -1을 리턴한다.
			</td>
		</tr>
		<tr>
