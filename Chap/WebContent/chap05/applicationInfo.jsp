...
<body>
	...
	<div class="tablestyle">
		...
		<br> 
		웹 어플리케이션 초기화 파라미터 읽어오기 <br> 
		서블릿 규약은 웹 어플리케이션 전체에 걸쳐서 사용할 수 있는 초기화 파라미터를 정의하고 있다. <br> 
		웹 어플리케이션에서 사용할 수 있는 초기화 파라미터는 WEB-INF\web.xml 파일에 &lt;context-param&gt; 태그를 사용하여 추가한다. <br>
		web.xml 파일에 초기화 파라미터를 추가하면, JSP는 application 기본 객체가 제공하는 메서드를 사용해서 초기화 파라미터를 사용할 수 있다. <br> 
		application 기본 객체는 초기화 파라미터를 읽어올 수 있는 메서드를 제공하고 있다. <br>
		...
		<br> <br> application 기본 객체는 현재 사용중인 웹 컨테이너에 대한 정보를 읽어오는
		메서드를 제공하고 있다. <br> application 기본 객체가 제공하는 서버 정보 관련 메서드 <br>
		<table border="1">
			<th>메서드</th>
			<th>리턴 타입</th>
			<th>설명</th>
